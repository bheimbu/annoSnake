...
rule setup_gtdb1:
    output:
       one=temp("databases/gtdb/.step1"),
       faa=temp("databases/gtdb/gtdb_vers202/gtdb_all.faa")
    conda:
...
rule setup_gtdb2:
    input:
        "databases/gtdb/.step1"
    output:
        lca="databases/gtdb/gtdb_vers202_lca.csv",
        two=touch("databases/gtdb/.step2")
    params:
