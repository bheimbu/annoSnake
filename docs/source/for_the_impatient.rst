...
.. important::
   ...
   **Note:** This workflow currently does not support Snakemake's module deployment mechanism (`snakedeploy`). See section "Known limitation" for details and the recommended direct-clone usage instead.
